...
2026-09-12。用户明确要求下载到桌面；原始数据和文章副本保存在 `~/Desktop/plainvoice-data-2026-09-12/`，没有上传此 Git 仓库。以下是实际完成记录，区别于先前的采集建议。
...
`agentic-technical/` 保存单独的来源说明和小样本。研究与字段区别见 [agentic／技术写作数据调查](research/09-12-agentic-technical-datasets.md)。
