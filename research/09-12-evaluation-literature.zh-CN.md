...
执行口径：本备忘录保留文献推导出的备选量表与规模；第一轮统一采用[标注协议 v0.1](../09-12-annotation-protocol.zh-CN.md)的 0–3 问题严重度，以及[主方案](../09-12-research-and-experiment-plan.zh-CN.md)的 80 项 pilot、实验臂编号和统计规则。
