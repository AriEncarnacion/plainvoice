...
新增 AI 对照见 [本轮交付说明](09-12-low-cost-ai-enrichment.zh-CN.md)。共覆盖 839 个目标来源；11 稿附具体语义问题标记，其他稿件也尚未人工验收。默认进入新文章组，旧记录和个人评审不变。

## 审阅方式

最新默认使用[清理后的正文](09-12-text-cleaning.zh-CN.md)。可切换原始版本、查看逐条清理记录、按候选／隔离状态筛选，并下载当前对照文本。原始评审与清理后的评审按内容 hash 分开。
...
核验范围见 [QA 记录](qa/09-12-viewer-qa.zh-CN.md)。
